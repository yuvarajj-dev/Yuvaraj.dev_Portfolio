...
import anime from 'animejs'; // Importing Anime.js
import "./About.css";

export default function About() {
  const [sphereEl, setSphereEl] = useState(null); // State for the sphere element

  useEffect(() => {
    // Function to fit the sphere element to its parent
    ...
    if (sphereEl) {
      // Run the fitting function for the sphere element
